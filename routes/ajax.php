...
Route::prefix('ajax')->group(function () {
    ...
    Route::get('employee-details-new', [AjaxController::class, 'EmployeeDetailsNew']);
    ...
    Route::any('view-forward-user-data', [AjaxController::class,'ViewForwardUserData']);
    Route::any('send-forward-request', [AjaxController::class,'SendForwardRequest']);
    Route::any('withdraw-employee-leaves', [AjaxController::class,'WithdrawLeaves']);
	
    Route::any('assign-leaves', [AjaxController::class,'assignYearlyLeavesToEmployee']);
    Route::any('deduct-casual-leave', [AjaxController::class,'deductCasualLeaveForShortLeave']);
	Route::any('apply-leaves-by-authority', [AjaxController::class,'checkForAuthorityLeave']);
	
	Route::any('employee-leave-status', [AjaxController::class,'employeeLeaveStatus']);
	Route::any('update-tour-leave-end-date', [AjaxController::class,'updateTourLeaveEndDate']);
    ...
    Route::get('get-role-masters', [AjaxController::class,'GetRoleMasters']);
    Route::get('get-user-list', [AjaxController::class,'GetUserList']);
