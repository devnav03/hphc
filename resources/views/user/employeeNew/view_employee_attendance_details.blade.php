                    ...
                    {data: null,
                        mRender:function ( data, type, row ) {
                            if(data.in_status == 'Yes'){
                             return '<a href="http://10.146.19.59:8000/'+data.in_image+'" target="_blank"><img src="http://10.146.19.59:8000/'+data.in_image+'" style="width: 3.187rem;height: 3.187rem;"/></a>';
                    ...
                    {data: null,
                        mRender:function ( data, type, row ) {
                            ...
                            if(data.out_status == 'Yes'){
                             return '<a href="http://10.146.19.59:8000/'+data.out_image+'" target="_blank"><img src="hhttp://10.146.19.59:8000/'+data.out_image+'" style="width: 3.187rem;height: 3.187rem;"/></a>';
            ...
            var datatable = $('#example').dataTable({
                ...
                columns: [
                    ...
                    {data: null,
                        mRender:function ( data, type, row ) {
                             if(data.out_status == 'Yes'){
                             return '<a href="http://10.146.19.59:8000/'+data.out_image+'" target="_blank"><img src="http://10.146.19.59:8000//'+data.out_image+'" style="width: 3.187rem;height: 3.187rem;"/></a>';
