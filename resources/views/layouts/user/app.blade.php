		...
		<div class="container-scroller d-flex">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				...
				<?php
					...
					$user_id = Auth::user()->id;
					$check_leave_authority = DB::table('leave_authorities')->select('flow_id')->where('orgnization_id',$organisation_id)->where('user_id',$user_id)->get();
					
					
					if(count($check_leave_authority) || $slug=="leave-authority"){ ?>
					<li class="nav-item">
						<a class="nav-link" data-toggle="collapse" href="#leave_authorities" aria-expanded="false" aria-controls="leave_authorities">
							<i class="mdi mdi-bookmark-check menu-icon"></i>
							<span class="menu-title">Leave Authority</span>
							<i class="menu-arrow"></i>
						</a>
						<div class="collapse" id="leave_authorities">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"> <a class="nav-link" href="{{url('leave-for-approval')}}">Approve Leaves</a></li>
							</ul>
						</div>
					</li>				
					<?php 
					...
					<?php if($slug=="employee-management"){ ?>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="ui-basic">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item"> <a class="nav-link" href="{{url('add-user-employeess')}}">Add Employee</a></li>
									<li class="nav-item"> <a class="nav-link" href="{{route('employee.user-details')}}">Employee List</a></li>
