                        ...
                        <form class="forms-sample row" action="{{url('hiring-status-approval')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <option value="">--Select--</option>
                                        <option value="1" @if(!empty($update->status_id)) @if($update->status_id==$row->id) selected @endif @endif>Approve</option>
                                        <option value="2" @if(!empty($update->status_id)) @if($update->status_id==$row->id) selected @endif @endif>Reject</option>
                                        <option value="3" @if(!empty($update->status_id)) @if($update->status_id==$row->id) selected @endif @endif>Forward</option>
                                    </select>
                                </div>
                            </div>
